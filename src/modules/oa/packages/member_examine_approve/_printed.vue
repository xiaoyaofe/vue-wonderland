<template>
	<div class="card approve_desc_page">
          ...
          <el-popover placement="right" width="300" trigger="click">
			...
			<el-row type="flex">
				<div class="item">
					...
					<el-col class="value">
						{{ approval_application_detail_info.applicationDetailInfo.companyId }}
					</el-col>
				</div>
			</el-row>
			...
			<el-row type="flex">
				...
				<el-col class="value">
					{{ approval_application_detail_info.applicationDetailInfo.sealSn }}
				</el-col>
				<el-col class="label">
					*用印数量：
				</el-col>
				<el-col class="value">
					{{ approval_application_detail_info.applicationDetailInfo.sealCount }}
				</el-col>
			</el-row>
			...
			<el-row type="flex">
				...
				<el-col class="value">
					{{ approval_application_detail_info.applicationDetailInfo.fileName }}
				</el-col>
			</el-row>
			...
			<el-row type="flex">
				...
				<el-col class="value full">
					{{ approval_application_detail_info.applicationDetailInfo.fileContent }}
				</el-col>
			</el-row>
			...
			<el-row type="flex">
				...
				<el-col class="value">
					{{
						options_seal_type
							.filter(item => approval_application_detail_info.applicationDetailInfo.sealType.includes(item.value))
							.map(item => item.label)
							.join("，")
					}}
				</el-col>
        ...
        <el-col class="value">
          <el-input :size="input_size" v-model="model.sealSn" v-required="model.sealSn" />
        </el-col> -->
				<el-col class="label">
					*用印数量：
				</el-col>
				<el-col class="value">
					<el-input :size="input_size" type="number" v-model="model.sealCount" v-required="model.sealCount" />
				</el-col>
			</el-row>
			...
			<el-row type="flex">
				...
				<el-col class="value">
					<el-input :size="input_size" v-model="model.fileName" v-required="model.fileName" />
				</el-col>
			</el-row>
			...
			<el-row type="flex">
				...
				<el-col class="value full">
					<el-input type="textarea" v-model="model.fileContent" v-required="model.fileContent" />
				</el-col>
			</el-row>
			...
			<el-row type="flex">
				...
				<el-col class="value">
					<el-checkbox-group v-model="check_list" v-required="model.sealType">
						<el-checkbox v-for="item in options_seal_type" :key="item.value" :label="item.value" :value="item.value">{{ item.label }}</el-checkbox>
					</el-checkbox-group>
				</el-col>
			</el-row>
...
<script lang="ts">
	...
	export default class Card extends Vue {
		...
		model = {
			...
			/** 文件内容 */
			fileContent: "",
			/** 印章类型 1：公章 2：法人章 3：财务章 类型之间用逗号隔开 */
			sealType: "",
			/** 用印数量 */
			sealCount: "",
			/* 附件 */
		...
		check_list = [];
		@Watch("check_list")
		changed_check_list(val) {
			this.model.sealType = val.join(",");
		}
