...
var corpId = 'wwc5265d7ecd0d5d29';
var token = 'cpSQangHbOML';
var EncodingAESKey = 'd90PPzH9PBswg5lLsUnDjvoDmvpdp3h5a6N6xfWMq4l';
 ...
 */
function reply(fromUsername, toUsername, msgType) {
  var info = {}
 ...
 * */
function send(fromUsername, toUsername, msgType) {
  var xml = reply(fromUsername, toUsername, msgType);
        ...
        try {
          ...
          xml2js.parseString(xml, {
            ...
            xml2js.parseString(messageWrapXml, {
              ...
              switch (msgType) {
                case 'text':
                  var sendContent = send(fromUsername, toUsername, msgType);
